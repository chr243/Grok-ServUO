// Server-to-client Huffman code table from the UO protocol, mirroring Server/Network/Compression.cs
// (pairs of bit length + code, symbols 0-255 plus the 256 terminator). Used to decode the stream.
namespace UoTest
{
    internal static partial class HuffmanTable
    {
		internal static readonly int[] Table = new int[514]
		{
